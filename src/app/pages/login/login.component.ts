export class LoginComponent {
    ...
    static handleFormSwitch() {
        $('#m_login_forget_password').click((e) => {
            e.preventDefault();
            LoginComponent.displayForgetPasswordForm();
        });

        $('#m_login_forget_password_cancel').click((e) => {
            e.preventDefault();
            LoginComponent.displaySignInForm();
        });

        $('#m_login_signup').click((e) => {
            e.preventDefault();
            LoginComponent.displaySignUpForm();
        });
    ...
    static init() {
        LoginComponent.handleFormSwitch();
        LoginComponent.handleSignInFormSubmit();
        LoginComponent.handleSignUpFormSubmit();
        LoginComponent.handleForgetPasswordFormSubmit();
    }
}